...
public class Function {
    ...
    public static boolean saveSignupDetails(String username, String email, String hashedPassword, String role, double xCoordinate, double yCoordinate,double points) {
        try (Connection connection = Database.getConnection()) {
            if (connection != null) {
                ...
                try (PreparedStatement preparedStatement = connection.prepareStatement(insertQuery)) {
                    ...
                    preparedStatement.setDouble(7, points);
